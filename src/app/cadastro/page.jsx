...
const RegistroPage = () => {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      if (!validatePassword()) {
        setError("As senhas devem ter pelo menos 8 caracteres e incluir um caractere especial, e ambas precisam ser iguais.");
        return;
      }
      setError(""); // Limpar mensagem de erro
      console.log("Novo usuário cadastrado:", nome, email, cpf);
    };
