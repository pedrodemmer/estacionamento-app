...
export async function initializeDatabase() {
    ...
    try {
      ...
      CREATE TABLE "mydb"."valores" (
        "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
        "valor" DECIMAL(2) NOT NULL,
        "tempo_id" INT NOT NULL
      );
 
      CREATE TABLE "mydb"."vaga" (
        "id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
      ...
      CREATE UNIQUE INDEX "id_UNIQUE_usuario_id" ON "mydb"."usuario" ("id");
      ...
      CREATE INDEX "fk_vaga_endereco1_idx" ON "mydb"."vaga" ("endereco_id");
 
      CREATE INDEX "fk_vaga_valores1_idx" ON "mydb"."vaga" ("valores_id");
 
      CREATE UNIQUE INDEX "id_UNIQUE_registro" ON "mydb"."registro" ("id");
 
      CREATE INDEX "fk_historico_vaga1_idx" ON "mydb"."registro" ("vaga_id");
      ...
      ALTER TABLE "mydb"."vaga" ADD CONSTRAINT "fk_vaga_endereco1" FOREIGN KEY ("endereco_id") REFERENCES "mydb"."endereco" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
 
      ALTER TABLE "mydb"."vaga" ADD CONSTRAINT "fk_vaga_valores1" FOREIGN KEY ("valores_id") REFERENCES "mydb"."valores" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
 
      ALTER TABLE "mydb"."registro" ADD CONSTRAINT "fk_historico_vaga1" FOREIGN KEY ("vaga_id") REFERENCES "mydb"."vaga" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
